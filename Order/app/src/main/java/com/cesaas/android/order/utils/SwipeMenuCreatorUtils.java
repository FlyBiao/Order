...
public class SwipeMenuCreatorUtils {
    ...
    public SwipeMenuCreatorUtils(Context mContext){
     ...
     * initRecyclerView
     */
    public static void initRecyclerView(SwipeMenuRecyclerView mRecyclerView,Context mContext){
        mLinearLayoutManager = new LinearLayoutManager(mContext);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);// 布局管理器。
     ...
     * 菜单创建器。
     */
   public static SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        @Override
